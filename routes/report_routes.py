...
router_report = APIRouter(tags=["Reports"])
...
def summary():
    ...
    logger.info("Return total_books: %s, available_books: %s, currently_borrowed: %s, active_members: %s", 
...
def get_top_member():
    ...
    logger.info("Top member '%s'", member)
